...
#     '''
#     gets a parameter from the ros parameter server
#
#     input:
#             name: string containing the global name of the parameter ie: /node/param
#
#     output:
#             parameter as defined in the parameter server
#     '''
#     return rospy.get_param(name)



# def set_rosparam(name, param):
#     '''
#     sets a parameter in the ros parameter server
#
#     input:
#             name: string containing the name of the parameter relative to the node ie: param
#             param: string with data i.e.: "[1, 2, 4]" or "true" ...
#
#     output:
#             VOID
#     '''
#     rospy.set_param(name, param)
#     return
